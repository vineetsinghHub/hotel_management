...
import { campaigns, statusColor } from "@aura/shared/admin/adminMockData";
    ...
    <AdminLayout pageTitle="Marketing">
      ...
      <div className="bg-white rounded-[16px] border border-slate-200 overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          ...
          {!readOnly && <button className="text-xs bg-brand-primary text-white px-4 py-2 rounded-full" data-testid="new-campaign-btn">+ New campaign</button>}
        </div>
