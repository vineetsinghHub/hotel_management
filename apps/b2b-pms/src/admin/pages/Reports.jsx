...
import ReportBuilder from "@aura/b2b-pms/admin/components/ReportBuilder";
  ...
  return (
    <AdminLayout pageTitle="Reports">
      <div className="flex items-center justify-between mb-4">
        <div>
          <p className="text-eyebrow text-brand-accent">Analytics</p>
      ...
      {tab === "overview" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4" data-testid="reports-overview">
          ...
          <div className="p-5 rounded-[16px] bg-white border border-slate-200">
            <p className="text-eyebrow text-brand-accent">ADR</p>
            <ResponsiveContainer width="100%" height={240}>
      ...
      {tab === "nightaudit" && (
        <div className="bg-white rounded-[20px] border border-slate-200 p-8" data-testid="night-audit">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-eyebrow text-brand-accent">End of day · {new Date().toLocaleDateString()}</p>
          ...
          <div className="mt-5 grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={k.l} className="p-4 rounded-[14px] bg-brand-surface">
