...
import {
  ...
  setServiceStatus,
  SERVICE_META,
} from "@aura/shared/lib/serviceStatusStore";
import { useReadOnly } from "@aura/b2b-pms/admin/components/ReadOnlyBanner";
          ...
          {!closed && (
            <div className="mt-3">
              ...
              <input
                ...
                className="mt-1 w-full bg-white border border-slate-200 rounded-[10px] px-3 py-2 text-sm outline-none focus:border-brand-primary"
