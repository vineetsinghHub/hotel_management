      ...
      <div className="bg-white w-full max-w-6xl max-h-[92vh] overflow-y-auto rounded-t-[28px] md:rounded-[28px] shadow-[0_40px_100px_rgba(15,23,42,0.35)] relative reveal-scale">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 p-8 md:p-12">
          <div className="lg:col-span-2">
            <p className="text-eyebrow text-brand-accent">Signature Suite</p>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-5">
              {[
                ...
                <div key={s.l} className="border-l-2 border-brand-accent pl-4">
              ...
              <ul className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-8">
                {room.amenities.map((a) => (
                  <li key={a} className="flex items-center gap-3 text-slate-700 text-sm">
                    <span className="w-6 h-6 rounded-full bg-brand-accent/10 text-brand-accent flex items-center justify-center text-[10px]">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-[20px] bg-brand-surface border border-slate-200">
              ...
              <div className="p-6 rounded-[20px] bg-brand-surface border border-slate-200">
                ...
                <ul className="mt-4 space-y-3 text-sm text-slate-600">
                  <li className="flex gap-3"><i className="fa-regular fa-clock text-brand-accent mt-1"></i>Check-in from 14:00 · Check-out by 12:00</li>
                  <li className="flex gap-3"><i className="fa-solid fa-shield-halved text-brand-accent mt-1"></i>Free cancellation up to 48h before arrival</li>
                  <li className="flex gap-3"><i className="fa-solid fa-paw text-brand-accent mt-1"></i>Pets welcome with prior notice</li>
                  <li className="flex gap-3"><i className="fa-solid fa-utensils text-brand-accent mt-1"></i>Breakfast included for all guests</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <aside className="lg:col-span-1">
            <div className="lg:sticky lg:top-6 rounded-[20px] border border-slate-200 bg-white p-6 shadow-[0_20px_50px_rgba(15,23,42,0.06)]">
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 grid grid-cols-7 gap-1">
                  {Array.from({ length: 14 }).map((_, k) => {
                    ...
                    return (
                      <div key={k} className={`text-center rounded-[10px] py-2 ${active ? "bg-indigo-50 text-slate-900" : "bg-brand-surface text-slate-500"}`}>
              ...
              <button
                onClick={() => nav("/booking")}
                className="mt-6 w-full bg-brand-primary hover:bg-brand-primary-hover text-white text-sm py-4 rounded-full shadow-[0_10px_28px_rgba(79,70,229,0.32)]"
