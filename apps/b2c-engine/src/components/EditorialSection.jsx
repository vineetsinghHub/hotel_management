...
export const EditorialSection = () => {
  return (
    <section className="py-20 md:py-28 bg-brand-surface" data-testid="editorial-section">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {articles.map((a, i) => (
            <article key={a.id} className={`group ${i === 0 ? "md:col-span-2 md:row-span-2" : ""}`} data-testid={`editorial-${a.id}`}>
              ...
              <div className="mt-4">
                <p className="text-[10px] tracking-widest uppercase text-brand-accent">{a.kicker}</p>
