...
import { spaTreatments } from "@aura/shared/data/mockData";
...
export default function Spa() {
  ...
  return (
    <div className="bg-brand-surface" data-testid="spa-page">
      <Navbar transparent />
      ...
      <section className="relative h-[80vh] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 h-full flex flex-col justify-end pb-16">
          ...
          <p className="text-eyebrow text-brand-accent-hover">The Wellness Sanctuary</p>
      ...
      <section className="py-24 px-6 md:px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="mb-2">
              <p className="text-eyebrow text-brand-accent">Signature Rituals</p>
            ...
            {spaTreatments.map((t, i) => (
              <button
                ...
                className={`w-full text-left rounded-[20px] border transition-all p-6 flex items-start gap-6 ${
                  selected === t.id ? "border-brand-primary bg-white shadow-[0_16px_40px_rgba(79,70,229,0.10)]" : "border-slate-200 bg-white hover:border-slate-300"
                }`}
                data-testid={`treatment-${t.id}`}
                style={{ animationDelay: `${i * 60}ms` }}
              >
                <div className="w-16 h-16 rounded-[14px] bg-brand-accent/10 grid place-items-center flex-shrink-0">
                  <i className="fa-solid fa-spa text-brand-accent text-xl"></i>
                </div>
                  ...
                  return (
                    <button
                      ...
                      className={`py-2.5 rounded-[10px] text-xs font-mono transition-all ${
                        ...
                        slot === t ? "bg-brand-primary text-white" : "bg-brand-surface text-slate-700 hover:bg-slate-100"
                      }`}
                      data-testid={`slot-${t}`}
                    >
                      {t}
      ...
      <section className="py-20 px-6 md:px-10 bg-white border-y border-slate-200">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-eyebrow text-brand-accent">The Aura Method</p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={p.t}>
                <div className="w-14 h-14 mx-auto rounded-full bg-brand-accent/10 text-brand-accent grid place-items-center">
