...
import BookingWidget from "@aura/b2c-engine/components/BookingWidget";
import RoomCard from "@aura/b2c-engine/components/RoomCard";
import RoomDetailModal from "@aura/b2c-engine/components/RoomDetailModal";
import VideoHero from "@aura/b2c-engine/components/VideoHero";
import EditorialSection from "@aura/b2c-engine/components/EditorialSection";
import { property, highlights, rooms, testimonials, galleryImages, experiences } from "@aura/shared/data/mockData";
  ...
  return (
    <div className="bg-brand-surface" data-testid="home-page" data-template={tenant?.template}>
      ...
      <VideoHero poster={heroImage} sources={heroSources} className="" data-testid="hero-section">
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 pt-40 md:pt-48 pb-32">
          <div className="max-w-3xl reveal-up">
            <p className="text-eyebrow text-brand-accent-hover flex items-center gap-3">
              <span className="w-8 h-px bg-brand-accent-hover"></span>
            ...
            <div className="mt-14 flex items-center gap-8 text-white/80 text-sm">
              <div className="flex items-center gap-2">
                <div className="flex text-brand-accent-hover">
              ...
              <div className="hidden md:flex items-center gap-2">
                <i className="fa-solid fa-award text-brand-accent-hover"></i>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-2xl reveal-up">
              <p className="text-eyebrow text-brand-accent">The Property</p>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-5">
            {highlights.map((h, i) => (
              <div
                key={h.title}
                className="group p-8 bg-white rounded-[20px] border border-slate-200 hover:border-brand-accent/40 hover:-translate-y-1 transition-all duration-500 reveal-up"
                style={{ animationDelay: `${i * 60}ms` }}
              >
                <div className="w-12 h-12 rounded-full bg-brand-accent/10 text-brand-accent flex items-center justify-center group-hover:bg-brand-accent group-hover:text-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-2xl">
              <p className="text-eyebrow text-brand-accent">Accommodations</p>
      ...
      <section className="py-24 md:py-32 px-6 md:px-10" data-testid="home-experiences">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl">
            <p className="text-eyebrow text-brand-accent">Curated Journeys</p>
      ...
      <section className="py-24 md:py-32 px-6 md:px-10 bg-slate-900 text-white relative overflow-hidden" data-testid="testimonials">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-brand-accent/10 blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-indigo-500/10 blur-3xl"></div>
        <div className="max-w-4xl mx-auto text-center relative">
          <p className="text-eyebrow text-brand-accent-hover">Guest Journal</p>
          <div className="mt-8">
            <i className="fa-solid fa-quote-left text-brand-accent-hover text-3xl"></i>
            ...
            <div className="mt-8 flex items-center justify-center gap-2">
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all ${i === testimIndex ? "bg-brand-accent-hover w-10" : "bg-white/25 w-3"}`}
      ...
      <section className="py-24 md:py-32 px-6 md:px-10" data-testid="ig-gallery">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <p className="text-eyebrow text-brand-accent">@aurahotels</p>
