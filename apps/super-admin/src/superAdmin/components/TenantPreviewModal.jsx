    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex flex-col gap-1 w-[168px] p-3 border-r border-white/10 bg-slate-950/60 overflow-y-auto">
          ...
          <div className="mt-4 p-3 rounded-[10px] bg-brand-primary/10 border border-brand-primary/20">
            <p className="text-[9px] tracking-widest uppercase text-brand-accent-hover mb-1">Tier</p>
            ...
            {loading && (
              <div className="absolute inset-0 grid place-items-center bg-white/80 z-10 pointer-events-none" data-testid="preview-loading">
                <div className="flex flex-col items-center gap-2">
                  <i className="fa-solid fa-spinner animate-spin text-brand-primary text-lg"></i>
