    ...
    <div className={`${outer} w-full max-w-5xl mx-auto`} data-testid="booking-widget">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-1.5 md:gap-2 items-stretch">
        ...
        >
          ...
          <p className="text-xs text-[#C9A227] mt-0.5">{promo ? "12% applied" : "Optional"}</p>
        </button>

        {/* Search CTA */}
        <button
          onClick={() => nav("/booking")}
          className="md:col-span-2 bg-[#4F46E5] hover:bg-[#4338CA] text-white rounded-[20px] px-6 py-4 flex items-center justify-center gap-2 shadow-[0_10px_28px_rgba(79,70,229,0.35)] transition-all hover:-translate-y-0.5"
          ...
          {openCal && (
            <div className="md:col-span-6 bg-white rounded-[20px] p-5 border border-slate-200 shadow-[0_20px_50px_rgba(15,23,42,0.08)]" data-testid="calendar-popover">
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <p className="text-xs text-[#C9A227] font-medium">Cancellation: free</p>
              </div>
            </div>
          )}
          ...
          {openPromo && (
            <div className="md:col-span-3 bg-white rounded-[20px] p-5 border border-slate-200 shadow-[0_20px_50px_rgba(15,23,42,0.08)]" data-testid="promo-popover">
              ...
              <input
                ...
                className="w-full bg-[#FAFAF8] border border-slate-200 rounded-[14px] px-4 py-3 text-sm outline-none focus:border-[#4F46E5] font-mono tracking-wider"
                placeholder="AURA24"
