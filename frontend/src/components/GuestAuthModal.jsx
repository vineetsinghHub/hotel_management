...
import { mockGuestLogin, mockGuestRegister } from "@/lib/guestAuth";
    ...
    >
      ...
      >
        <div className="bg-white rounded-[24px] overflow-hidden shadow-[0_40px_120px_rgba(15,23,42,0.35)]">
          {/* Hero band */}
          <div className="relative px-8 py-8 bg-gradient-to-br from-slate-900 via-[#312E81] to-[#4F46E5] text-white overflow-hidden">
            <div className="absolute -top-16 -right-16 w-56 h-56 rounded-full bg-[#C9A227]/25 blur-3xl"></div>
            <button
              onClick={onClose}
            ...
            <p className="text-eyebrow text-[#E6C868]">Aura Hotels</p>
          ...
          <form onSubmit={submit} className="px-8 py-6 space-y-3">
            {mode === "signup" && (
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full bg-[#FAFAF8] border border-slate-200 rounded-full px-4 py-2.5 text-sm outline-none focus:border-[#4F46E5]"
            ...
            <button
              type="submit"
              disabled={busy}
              className="w-full mt-4 py-3 rounded-full bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm font-medium shadow-[0_10px_28px_rgba(79,70,229,0.28)] disabled:opacity-70 flex items-center justify-center gap-2"
