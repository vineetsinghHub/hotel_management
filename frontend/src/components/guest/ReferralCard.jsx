...
export const ReferralCard = () => {
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] p-8 md:p-10 bg-gradient-to-br from-[#4F46E5] to-[#3730A3] text-white" data-testid="referral-card">
      <div aria-hidden="true" className="absolute -right-16 -top-16 w-64 h-64 rounded-full bg-white/5"></div>
      <div aria-hidden="true" className="absolute -left-10 -bottom-10 w-56 h-56 rounded-full bg-[#C9A227]/15"></div>

      <p className="text-eyebrow text-[#E6C868] relative z-10">Aura Circle Referral</p>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3 relative z-10">
        <button onClick={share} className="px-6 py-3 rounded-full bg-[#C9A227] hover:bg-[#B08D1E] text-slate-900 text-sm font-medium" data-testid="referral-share">
