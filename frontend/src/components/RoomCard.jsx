    ...
    >
      ...
      <div className="p-7">
        ...
        <div className="mt-5 grid grid-cols-3 gap-2 text-center">
          <div className="py-2.5 rounded-[12px] bg-[#FAFAF8] border border-slate-100">
            <i className="fa-solid fa-user-group text-[#C9A227] text-xs"></i>
            <p className="text-xs text-slate-700 mt-1">{room.guests} Guests</p>
          </div>
          <div className="py-2.5 rounded-[12px] bg-[#FAFAF8] border border-slate-100">
            <i className="fa-solid fa-expand text-[#C9A227] text-xs"></i>
            <p className="text-xs text-slate-700 mt-1">{room.size} ft²</p>
          </div>
          <div className="py-2.5 rounded-[12px] bg-[#FAFAF8] border border-slate-100">
            <i className="fa-solid fa-bed text-[#C9A227] text-xs"></i>
