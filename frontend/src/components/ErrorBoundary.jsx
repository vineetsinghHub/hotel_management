...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center p-6" data-testid="error-boundary">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-eyebrow text-[#C9A227] mt-6">Something went sideways</p>
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <button
              onClick={this.reload}
              className="px-5 py-2.5 rounded-full bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm shadow-[0_10px_28px_rgba(79,70,229,0.28)]"
