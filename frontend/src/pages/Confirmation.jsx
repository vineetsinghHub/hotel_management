...
import { rooms, property } from "@/data/mockData";

const room = rooms[0];

export default function Confirmation() {
  return (
    <div className="bg-[#FAFAF8] min-h-screen" data-testid="confirmation-page">
      <Navbar />
          ...
          <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-slate-900 to-indigo-950 text-white p-10 md:p-14 reveal-in">
            ...
            <div className="relative">
              ...
              <h1 className="mt-6 font-serif text-5xl md:text-6xl leading-tight max-w-3xl">
                We look forward to <em className="italic text-[#E6C868] font-light">hosting</em> you, Aarav.
              </h1>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-6">
                <div>
                  <p className="text-eyebrow text-[#E6C868]">Reservation ID</p>
                  <p className="font-mono text-2xl mt-2">AH-9F27C1</p>
                </div>
                <div className="w-px h-12 bg-white/20"></div>
                <div>
                  <p className="text-eyebrow text-[#E6C868]">Arrival</p>
                  <p className="font-serif text-2xl mt-2">Nov 12, 2025</p>
                </div>
                <div className="w-px h-12 bg-white/20"></div>
                <div>
                  <p className="text-eyebrow text-[#E6C868]">Nights</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-[24px] border border-slate-200 p-8">
                <p className="text-eyebrow text-[#C9A227]">Journey Timeline</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-[24px] border border-slate-200 p-8">
                  <p className="text-eyebrow text-[#C9A227]">Guest Details</p>
                ...
                <div className="bg-white rounded-[24px] border border-slate-200 p-8">
                  <p className="text-eyebrow text-[#C9A227]">Room Summary</p>
              ...
              <div className="bg-white rounded-[24px] border border-slate-200 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="p-8">
                    <p className="text-eyebrow text-[#C9A227]">Directions</p>
                    ...
                    <div className="mt-5 space-y-3 text-sm text-slate-700">
                      <div className="flex gap-3"><i className="fa-solid fa-plane-arrival text-[#C9A227] mt-1"></i><span>Maharana Pratap Airport (UDR) · 22 km · 35 min</span></div>
                      <div className="flex gap-3"><i className="fa-solid fa-train text-[#C9A227] mt-1"></i><span>Udaipur City Railway · 6 km · 15 min</span></div>
                    </div>
                  ...
                  <div className="relative min-h-[240px] bg-slate-100">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white grid place-items-center shadow-lg">
                      <i className="fa-solid fa-location-dot text-[#4F46E5]"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <aside className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-[24px] border border-slate-200 p-6" data-testid="weather-widget">
                <p className="text-eyebrow text-[#C9A227]">Weather at Arrival</p>
                <div className="mt-4 flex items-baseline gap-3">
                  <p className="font-serif text-5xl text-slate-900">28°</p>
                  <p className="text-slate-500 text-sm">Sunny · Nov 12</p>
                </div>
                <i className="fa-solid fa-sun text-[#C9A227] text-4xl mt-2"></i>
                <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                  {["Wed", "Thu", "Fri"].map((d, i) => (
                    <div key={d} className="p-3 rounded-[12px] bg-[#FAFAF8]">
                      <p className="text-[10px] uppercase tracking-widest text-slate-400">{d}</p>
                      <i className={`${i === 0 ? "fa-solid fa-sun text-[#C9A227]" : "fa-solid fa-cloud-sun text-slate-400"} text-lg mt-1`}></i>
              ...
              <div className="bg-white rounded-[24px] border border-slate-200 p-6">
                <p className="text-eyebrow text-[#C9A227]">Hotel Contact</p>
                <div className="mt-4 space-y-3 text-sm text-slate-700">
                  <a href={`tel:${property.phone}`} className="flex items-center gap-3 hover:text-slate-900">
                    <i className="fa-solid fa-phone text-[#C9A227]"></i><span className="font-mono">{property.phone}</span>
                  </a>
                  <a href={`mailto:${property.email}`} className="flex items-center gap-3 hover:text-slate-900">
                    <i className="fa-regular fa-envelope text-[#C9A227]"></i><span className="font-mono">{property.email}</span>
                  </a>
                  <div className="flex items-center gap-3">
                    <i className="fa-solid fa-comments text-[#C9A227]"></i><span>WhatsApp concierge · 24/7</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[24px] border border-slate-200 p-6 space-y-3">
                <button className="w-full py-3 rounded-full bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm">
                ...
                <button className="w-full py-3 rounded-full border border-slate-200 text-slate-800 hover:bg-slate-50 text-sm">
                  <i className="fa-regular fa-envelope mr-2 text-[#C9A227]"></i>Email Invoice
                </button>
                <button className="w-full py-3 rounded-full border border-slate-200 text-slate-800 hover:bg-slate-50 text-sm">
                  <i className="fa-regular fa-calendar-plus mr-2 text-[#C9A227]"></i>Add to Calendar
                </button>
                <button className="w-full py-3 rounded-full border border-slate-200 text-slate-800 hover:bg-slate-50 text-sm">
                  <i className="fa-solid fa-diamond-turn-right mr-2 text-[#C9A227]"></i>Get Directions
                </button>
