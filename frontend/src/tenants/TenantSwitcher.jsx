...
import { listTenants } from "@/tenants/tenantRegistry";
        ...
        <div className="mb-2 min-w-[240px] bg-brand-surface-elev border border-brand-border rounded-[16px] shadow-[0_20px_50px_rgba(15,23,42,0.15)] overflow-hidden">
          ...
          {rest.map((t) => (
            ...
            >
              ...
              <span className={`text-[9px] tracking-widest uppercase px-1.5 py-0.5 rounded ${t.tier === "pro" ? "bg-gradient-to-r from-[#C9A227] to-[#E6C868] text-slate-900" : "bg-slate-200 text-slate-600"}`}>{t.tier}</span>
            </button>
          ))}
        </div>
      )}
